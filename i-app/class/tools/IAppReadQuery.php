...
class IAppReadQuery {
    ...
    public function __construct($str,$fileName_,$id) {
    ...
    function getPostObj($model,$key,$per){
        ...
        $newObj     = $model;
            ...
            if($per == "obj"){
                ...
                $newObj     = $this->convertQueryFun($resultObj,$key);
            }
    ...
    {
        return (array) [$this->objectSt_,$this->QMAP,$this->QJMAP,$this->DMAP];
    }
}
